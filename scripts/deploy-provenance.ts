...
/**
 * Déploie ProvenanceRegistry sur Base Sepolia. TESTNET UNIQUEMENT.
 * Le constructeur ne prend aucun argument : le registre n'a pas de propriétaire,
 * personne ne peut réécrire un enregistrement, pas même le déployeur.
 */
...
writeFileSync(
  resolve(root, "build/deployment-provenance.json"),
  JSON.stringify(
    {
...
console.log("   → build/deployment-provenance.json");
