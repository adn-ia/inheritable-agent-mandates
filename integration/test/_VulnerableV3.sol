...
// Build DELIBEREMENT vulnerable — un seul retrait par rapport a V3.
 ...
 */
contract VulnerableNoConservation {
    struct Mandate {
    ...
    function spawn(
        ...
        // RETIRE VOLONTAIREMENT : le debit. La garde subsiste mais ne voit jamais
        // rien d'alloue, donc chaque enfant peut reprendre tout le plafond du parent.
