...
/**
 * @title InheritableAgentMandateV2 — v1 + la clause `validUntil`
 ...
 *
 *         Le télomère, le plafond, le bail booléen et la marche non bornée du gel restent
 *         tels quels : ce contrat ne rejoue pas les choix de v1, il ajoute une clause.
 *
 *         Contrat de référence : minimal et lisible, non audité, testnet uniquement.
 */
contract InheritableAgentMandateV2 {
    struct Mandate {
